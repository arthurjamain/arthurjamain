...
define([
  ...
  var newView = Backbone.View.extend({
    ...
    enhance: function() {
      ...
      if (this.loadingClass && this.$el) {
        this.$el.addClass(this.loadingClass);
        this.unbind('load', this.removeLoadingClass, this);
        this.bind('load', this.removeLoadingClass, this);
      }
    },

    /**
     * Removes the "loading" class from the view's element when the
