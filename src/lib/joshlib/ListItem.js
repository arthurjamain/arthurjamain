...
define(["lib/joshlib/Item","underscore"], function(UIElement,_) {
  ...
  var UIListItem = UIElement.extend({
    ...
    setElement: function(el) {
      // NB: this is not correct, the view must have its own element
      // that is different from that of its child view.
      // See comment above for details.
      if (this.view) this.view.setElement(el);
    },
